  ...
  return (
    <div className="relative flex flex-col items-center min-h-screen bg-zinc-900 text-white p-4">
      ...
      <div
        ...
        style={{ backgroundImage: `url('/kaidirlogo.jpg')` }}
      >
        {/* Top Fading Effect */}
      ...
      <div className="w-full max-w-md flex justify-center space-x-4">
        ...
        <button
          onClick={() =>
            handleExternalLink(
              "https://www.instagram.com/kadirigoldjewelleryllc/"
            )
          }
          className="w-12 h-12 rounded-full bg-zinc-800 flex items-center justify-center shadow-md hover:bg-zinc-700 transition-all"
        >
        ...
        <button
          onClick={() =>
            handleExternalLink("https://maps.app.goo.gl/tRz4tXwBv1oKqfw96")
          }
          className="w-12 h-12 rounded-full bg-zinc-800 flex items-center justify-center shadow-md hover:bg-zinc-700 transition-all"
        >
      ...
      <div className="w-full max-w-md bg-zinc-800 rounded-lg p-6 shadow-lg mt-6">
        ...
        <p className="text-gray-400">
          Kadiri Gold is a trusted name in the bullion and jewellery industry,
          offering premium-quality gold products and exceptional service.
          Specializing in gold bullion, coins, and exquisite jewellery, we cater
          to investors and collectors seeking reliability and elegance.
        </p>
      </div>
      ...
      <div className="w-full max-w-md flex justify-center space-x-4 mt-6">
        <button
          onClick={() =>
            handleExternalLink(
              "https://apps.apple.com/in/app/kadiri-gold-jewellery/id6741804948"
            )
          }
        ...
        <button
          onClick={() =>
            handleExternalLink(
              "https://play.google.com/store/apps/details?id=com.artifitia.kadirigoldbullion&pcampaignid=web_share"
            )
          }
          className="hover:opacity-80 transition-all"
        >
